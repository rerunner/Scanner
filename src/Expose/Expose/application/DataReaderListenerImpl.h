...
private:
  ...
  std::unique_ptr<UnitOfWork> &whmContext; // Will never take ownership of the context
...
public:
  ...
  DataReaderListenerImpl(std::unique_ptr<UnitOfWork> & passedContext, std::promise<std::string>* heightmapId);
